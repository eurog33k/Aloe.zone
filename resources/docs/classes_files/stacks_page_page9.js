...
stacks.stacks_in_p47_n1_page9 = {};

stacks.stacks_in_p47_n1_page9 = (function(stack) {
...
stacks.stacks_in_p47_n3_page9 = {};

stacks.stacks_in_p47_n3_page9 = (function(stack) {

    var jQuery = stacks.jQuery;
    var $ = jQuery;

 var subNavIndex=1,divide=1,zoneDivider=0,fullWidthMenu='full-width',scope='all',style='solid',menuAlign='right',styleActive=''==='styleActive'?true:false,rwmenu='rw'==='rw'?true:false,magellan='rw'==='magellan'?true:false,dropdowns='#stacks_in_p47_n3_page9 ul:not(.title-area) li.has-dropdown';$(document).ready(function(){var stack=$('#stacks_in_p47_n3_page9');stack.parent().css({overflow:'visible'});$('.top-bar-section:not(.menu-magellan):not(.menu-none)',stack).rwflexnav({scope:scope,subNavIndex:subNavIndex,divide:divide});if(magellan){if(divide)$('ul.magellanList',stack).divideNav();$('.magellanList li',stack).each(function(){var id=$(this).data('magellan-arrival');$('a',this).attr('href','#'+id);});}
if($('ul.zone',stack).exists()){if(zoneDivider)$('ul.zone',stack).divideNav();}
if($('.zone-align-left ul.zone',stack).exists()||!$('ul.zone',stack).exists()){$('ul.menu',stack).addClass(menuAlign);}
if(fullWidthMenu==='full-width'&&menuAlign==='centered'){var calcMenuItemWidth=function(){var items=$('.menu-align-centered ul.menu > li:not(.divider)',stack),dividers=$('.menu-align-centered ul.menu > li.divider',stack);if($('.top-bar .toggle-topbar',stack).is(':visible')){items.removeAttr('style');}
else{var count=items.length;if(count>0){var width=dividers.length>0?100/count-0.2:100/count;items.width(width+"%");}}};calcMenuItemWidth();$(window).on('resize',calcMenuItemWidth);}
$(dropdowns).attr('aria-haspopup','true');$(dropdowns).hover(function(){$('> a:not(.button)',this).addClass('hovered');},function(){$('> a:not(.button)',this).removeClass('hovered');});});$(window).load(function(){var stack=$('#stacks_in_p47_n3_page9');if('40.063em'==='62.563em'){$('.parent-link.hide-for-medium-up',stack).removeClass('hide-for-medium-up').addClass('hide-for-large-up');}
...
stacks.stacks_in_230_page9 = {};

stacks.stacks_in_230_page9 = (function(stack) {
...
$(function() {
  ...
  rNav.pin({containerSelector: "#rails-wrapper",minWidth: 700}).singlePageNav({
      filter: ':not(.external)',
      offset: 80,
      updateHash: false,
      speed: 1000,
